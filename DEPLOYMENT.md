...
`render.yaml` includes placeholder values for these required Render environment variables. Replace them in the Render dashboard before relying on the deployment:

```text
TELEGRAM_BOT_TOKEN=REPLACE_ME_TELEGRAM_BOT_TOKEN
BOT_ADMIN_IDS=123456789
DATABASE_URL=postgresql://replace_me:replace_me@replace-me.supabase.co:5432/postgres
PUBLIC_BASE_URL=https://replace-me.onrender.com
```
